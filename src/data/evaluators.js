  ...
  behavioral: [
    {
      ...
      icon: '💼',
      style: '솔직하고 실무적',
      description: '경력 8년차. 실무 역량과 팀 적합성을 냉정하게 평가합니다.',
    ...
    },
    {
      ...
      icon: '📋',
      style: '격려와 코칭 중심',
      description: '경력 10년차. 답변 구조와 전달력을 분석하고 개선 방향을 제시합니다.',
    ...
    },
    {
      ...
      icon: '🏢',
      style: '전략적, 큰 그림',
      description: '경력 15년차. 성장 가능성과 조직 적합성을 종합적으로 판단합니다.',
  ...
  technical: [
    {
      ...
      icon: '🎮',
      style: '솔직하고 직설적',
      description: '경력 7년차. 기술적 정확성과 실무 적용 가능성을 평가합니다.',
