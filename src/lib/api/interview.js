 ...
 * STT 교정 완료된 텍스트를 받아 꼬리질문 필요 여부를 판단하고 생성한다.
 *
 * @param {string} questionText - 메인 질문 텍스트
 * @param {string} correctedTranscript - Whisper STT + LLM 교정 완료된 답변 텍스트
 ...
 * @param {number} followUpCount - 현재 세션 꼬리질문 누적 횟수
 * @param {number} maxFollowUps - 최대 허용 꼬리질문 횟수
